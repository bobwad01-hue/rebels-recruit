...
type Props={relationshipId?:string|null;autoScore:number;autoLabel:string;reasons:string[];manualScore?:number|null;momentum?:string;confidence?:string;};

export default function RelationshipStrengthCard({relationshipId,autoScore,autoLabel,reasons,manualScore,momentum,confidence}:Props){
