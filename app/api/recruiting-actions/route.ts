...
const NEXT:Record<string,Record<string,{state:string;next:string;decision:string;remindDays?:number}>>={
 visit_confirmation:{prepare_visit:{state:'prepare',next:'Prepare for the visit and plan your post-visit follow-up',decision:'confirmed'}},
 ...
 questionnaire:{complete:{state:'external',next:'Complete the recruiting questionnaire',decision:'complete'},later:{state:'deferred',next:'Complete recruiting questionnaire',decision:'later',remindDays:3},submitted:{state:'reply',next:'Let the coach know the questionnaire is complete',decision:'submitted'}},
