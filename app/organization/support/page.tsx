...
export default async function SupportPage(){
  ...
  return <AppShell><div className="max-w-6xl mx-auto px-5 md:px-8 py-6"><PageHeader title="Support Cases" subtitle="Investigate issues reported specifically to this organization without changing recruiting data until the cause is clear."/>
