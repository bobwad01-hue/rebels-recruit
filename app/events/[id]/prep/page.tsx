...
export default function EventPrep() {
  ...
  const [event, setEvent] = useState<any>(null),
    ...
    [outreachMessage,setOutreachMessage]=useState<any>(null),
    ...
    (async () => {
      ...
      if (e?.college_id) {
        const [historyResult, interactionCountResult, coachResult, directoryResult] = await Promise.all([
          c
            .from("interactions")
            .select("id,coach_id,type,date,note,initiated_by,email_subject,email_type,email_content,interaction_recipients(coach_id,recipient_type)")
