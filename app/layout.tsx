...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body><ProductionErrorMonitor/><WebVitalsMonitor/><SuccessFeedback/><EventLinkNormalizer/><NavigationEnhancer/>{children}</body></html>}
